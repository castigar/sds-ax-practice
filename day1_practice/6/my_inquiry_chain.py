...
class codeReviewRequest(BaseModel):
    tag: str = Field(description="review 성격: 'bugFix', 'featureImplement' 중 하나")
    urgency: str = Field(description="긴급도: '높음', '보통', '낮음' 중 하나")
review_parser = JsonOutputParser(pydantic_object=codeReviewRequest)
review_request = PromptTemplate(
    template=""
)
