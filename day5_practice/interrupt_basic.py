...
class State(TypedDict):
    ...
    pending_action: str # HITL을 위함
    decision: str # HITL을 위함
...
def main():
    ...
    with SqliteSaver.from_conn_string("checkpoints.sqlite") as checkpointer:
        ...
        config = {"configurable": {"thread_id": "hitl_demo"}} # thread_id에 유의
        ...
        print("\n[2차 invoke]")
        result = graph.invoke(Command(resume=user_decision), config=config) # 결과 입력 받는 루트
